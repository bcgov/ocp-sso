...
curl -sSk -o sso72-x509-postgresql-secrets.yaml "${PATRONI_BASE_URL}/openshift/deployment-prereq.yaml"
curl -sSk -o sso72-x509-postgresql.yaml "${PATRONI_BASE_URL}/openshift/deployment.yaml"
